...
"[project]/OneDrive/Desktop/RFA/Recyclable_fashion_brand/frontend/script.js [client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function handleUserLogin(event1) {
...
function handleAdminLogin(event1) {
    event1.preventDefault();
...
function initImageUpload() {
    ...
    if (uploadZone) {
        ...
        uploadZone.addEventListener('dragover', (e)=>{
            e.preventDefault();
            uploadZone.style.borderColor = 'var(--green-mid)';
        });
...
//# sourceMappingURL=OneDrive_Desktop_RFA_Recyclable_fashion_brand_frontend_script_0rpr4kp.js.map